...
static const _CameraControl_type_support_symbol_names_t _CameraControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flir_camera_msgs, msg, CameraControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flir_camera_msgs, msg, CameraControl)),
  }
};
...
{
  return &::flir_camera_msgs::msg::rosidl_typesupport_cpp::CameraControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, flir_camera_msgs, msg, CameraControl)() {
  return get_message_type_support_handle<flir_camera_msgs::msg::CameraControl>();
}
