...
#include "flir_camera_msgs/msg/detail/camera_control__type_support.h"
...
static const _CameraControl_type_support_symbol_names_t _CameraControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flir_camera_msgs, msg, CameraControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flir_camera_msgs, msg, CameraControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flir_camera_msgs, msg, CameraControl)() {
  return &::flir_camera_msgs::msg::rosidl_typesupport_c::CameraControl_message_type_support_handle;
}
